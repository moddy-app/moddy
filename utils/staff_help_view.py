...
COMMAND_CATEGORIES = {
    ...
    "developer": {
        ...
        "commands": [
            ("d.reload [extension]", "Reload bot extensions (omit for all)"),
            ...
            ("d.sync [guild_id|global]", "Sync slash commands globally or to a guild"),
            ("d.serverlist", "List all servers the bot is in (paginated)"),
            ("d.cogs", "List all loaded cogs with status"),
            ("d.disable [CogName]", "Disable a cog at runtime"),
            ("d.enable [CogName]", "Re-enable a cog at runtime"),
            ("d.disabled", "List currently disabled cogs"),
            ...
            ("d.redirect add", "Open modal to create a redirect link (path auto-generated)"),
            ("d.redirect edit [id]", "Open modal to edit an existing redirect link"),
