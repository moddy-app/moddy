...
from utils.emojis import (
    ...
    TICKET_ACCESS, TICKET_CATEGORY, TICKET_CLAIM,
...
class CategoryMessagesModal(BaseModal):
    ...
    written in the **server** language, not the admin's (``ticket_locale``):
    these are the words the member will read. Only the labels around them
    follow the admin.
    """
